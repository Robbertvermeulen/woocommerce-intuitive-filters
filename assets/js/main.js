...
/* harmony import */ var _FilterDropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FilterDropdown */ "./src/components/FilterDropdown.js");
...
const Filter = _ref => {
  ...
  const handleSubmit = async () => {
    if (submitReady) {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().post(window.wif_plugin.ajaxUrl, qs__WEBPACK_IMPORTED_MODULE_2___default().stringify({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    switch (element.type) {
      ...
      case "dropdown":
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_FilterDropdown__WEBPACK_IMPORTED_MODULE_3__["default"], {
          key: i,
          name: element.name,
...
const FilterDropdown = _ref => {
  ...
  if (options && options.length > 0) options === null || options === void 0 ? void 0 : options.sort((x, y) => x.value === value ? -1 : y.value === value ? 1 : 0);
  useEffect(() => {
...
if (filterContainer) {
  ...
  if ((_window$wif = window.wif) !== null && _window$wif !== void 0 && _window$wif.structure) {
    ...
    render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Filter__WEBPACK_IMPORTED_MODULE_1__["default"], {
      filterId: (_window$wif2 = window.wif) === null || _window$wif2 === void 0 ? void 0 : _window$wif2.filterId,
      structure: window.wif.structure,
      initialFilters: (_window$wif3 = window.wif) === null || _window$wif3 === void 0 ? void 0 : _window$wif3.initialFilters
    }), filterContainer);
  }
}
}();
